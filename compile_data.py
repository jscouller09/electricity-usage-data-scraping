...
bill_end = pd.Timestamp(pd.to_datetime('26/06/2024', dayfirst=True) + pd.Timedelta(hours=23), tz='Pacific/Auckland') # total for last hour of the billing period is at 23:00
